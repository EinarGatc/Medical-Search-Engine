...
<html lang="en" id="home" class="nojs us" data-root="https://medlineplus.gov/">
    ...
    <head>
        ...
        <link rel="alternate" type="application/rss+xml" title="MedlinePlus on Twitter" href="https://public.govdelivery.com/topics/USNLMMP_895/feed.rss" />
        

        <title>MedlinePlus - Health Information from the National Library of Medicine</title>

        <link rel="stylesheet" href="https://medlineplus.gov/css/common_new.css?1718630129141" />
                ...
                <div id="mplus-header">
                    ...
                    <div id="mplus-logo" class="years-25">
                        <a href="https://medlineplus.gov/">
                            <img src="https://medlineplus.gov/images/m_logo_primary_25.png" alt="MedlinePlus Trusted Health Information for You" class="primary"/>
                        </a>
                    </div>
    ...
    <article>
		...
		<div class="featured">
			...
			<div class="featured-image">
				...
				<a href="https://medlineplus.gov/scleroderma.html " title="Scleroderma">
				<img id="feature-img" src="https://medlineplus.gov/images/featured/Scleroderma_share_2_featured.jpg" alt="Scleroderma"/>
				</a>
			...
			<div class="featured-content">					
				<dl>
					...
					<dd class="feature-term">Scleroderma</dd>
					<dt class="feature-def2">Scleroderma is an autoimmune disease that causes inflammation and thickening in the skin and other areas of the body. The exact cause of scleroderma is unknown.</dt>
					<dd><a class="link-nav" title="Learn more about Scleroderma" href="https://medlineplus.gov/scleroderma.html ">Learn more</a></dd>
			    ...
			    <li><a href="https://medlineplus.gov/whatsnew/">What's New</a></li>
                        ...
                        <ul class="follow-footer">
                            ...
                            <li>
                                ...
                                <a href="https://twitter.com/medlineplus" class="follow-item" target="_blank">
                                    <img src="https://medlineplus.gov/images/i_share_twitter.png" class="follow-icon" alt="Twitter" title="Twitter">
                                </a>
                    ...
                    <div class="footer2">
                        ...
                        <div class="address">
                            ...
                            <a target="_blank" href="http://www.nih.gov/icd/od/foia/index.htm">FOIA</a>
